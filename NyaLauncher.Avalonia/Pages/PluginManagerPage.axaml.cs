...
public partial class PluginManagerPage : UserControl
{
    ...
    private async Task<bool> ConfirmUninstallAsync(PluginSnapshot plugin)
    {
        ...
        var uninstall = new Button
        {
            ...
            MinWidth = 104,
            Padding = new Thickness(14, 7),
            Background = Brush.Parse("#412832"),
            Foreground = Brush.Parse("#F1A7B6")
        };
        var dialog = new Window
        {
            Title = "确认卸载插件",
                    ...
                    Children =
                    {
                        ...
                        new TextBlock
                        {
                            Text =
                                ...
                                "该安装的能力授权和来源快照会被撤销。",
                            Foreground = Brush.Parse("#E7EAF7"),
                            TextWrapping = TextWrapping.Wrap
                        },
                        new Border
                        {
                            Background = Brush.Parse("#403522"),
